...
const Header = () => {
  ...
  return (
    <div className="container mx-auto px-10 mb-8">
      <div className="border-b w-full border-green-600 py-8 flex flex-row justify-between items-center">
        <div className="mb:float-left block">
          <Link href="/">
            <span className="cursor-pointer font-bold text-4xl text-green-400">
              Jeffersondrs Blog's
            </span>
          </Link>
        </div>
